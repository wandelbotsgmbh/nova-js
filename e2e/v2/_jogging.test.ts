...
// test.skip("jog a robot somewhat", async () => {
...
//   // Please note, moved to react components
//   const jogger = await JoggerConnection.open(nova, virtualMotionGroup.motion_group)
